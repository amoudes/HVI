...
Lz = ny*Ly;
nhz = Lz / hmax;   % nr of elements in Z
%%
%      1 2  3  4    5    6  7      8
...
fprintf(fid,'elgenerate solid solidfacedrag 2 30000000 %.4f %d 0 0 0 0 0 4\n',[Lz,nhz]);
fprintf(fid,'genselect clear\n');
...
fprintf(fid,'renumber setkind NODE 9999999\n');
fprintf(fid,'renumber setrange 1 2612680 2612680\n');
fprintf(fid,'renumber renumkind 170\n');
fprintf(fid,'renumber keyword\n');
fprintf(fid,'renum occupant models\n');
fprintf(fid,'renumber clean\n');
fprintf(fid,'renumber offset 0\n');
fprintf(fid,'renumber setkind SOLID_ELEM 9999999\n');
fprintf(fid,'renumber setrange 30000000 31977599 1977600\n');
...
p2 = [Cds(1,1)-t-TOL_g Cds(2,1)-TOL_g-ty  Lz+TOL_g];
fprintf(fid,'genselect node add box in %.5f %.5f %.5f %.5f %.5f %.5f\n',[p1, p2]);
p1 = [Cds(1,end-4)-t+TOL_g Cds(2,end-4)+TOL_g+ty     -TOL_g];
p2 = [Cds(1,end-4)-t-TOL_g Cds(2,end-4)-TOL_g+ty      Lz+TOL_g];
fprintf(fid,'genselect node add box in %.5f %.5f %.5f %.5f %.5f %.5f\n',[p1 p2]);
p1 = [Cds(1,end-4)-t+TOL_g  1000     -TOL_g];
p2 = [Cds(1,end-4)-t-TOL_g -1000     +TOL_g];
fprintf(fid,'genselect node add box in %.5f %.5f %.5f %.5f %.5f %.5f\n',[p1 p2]);
p1 = [Cds(1,end-4)-t+TOL_g  1000     Lz-TOL_g];
p2 = [Cds(1,end-4)-t-TOL_g -1000    Lz+TOL_g];
fprintf(fid,'genselect node add box in %.5f %.5f %.5f %.5f %.5f %.5f\n',[p1 p2]);
